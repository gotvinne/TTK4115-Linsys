...
MODEL                = heli_task_3_integral
MODULES              = heli_task_3_integral_data.c heli_task_3_integral_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = heli_task_3_integral.mk
...
MODELLIB                  = heli_task_3_integrallib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = heli_task_3_integral_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = D:\HELIKO~1\DAG~~~3\TASK3L~1\Driver2
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\heli_task_3_integral_quarc_win64
