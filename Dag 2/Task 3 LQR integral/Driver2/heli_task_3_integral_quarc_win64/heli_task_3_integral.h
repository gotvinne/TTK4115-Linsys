...
#ifndef RTW_HEADER_heli_task_3_integral_h_
#define RTW_HEADER_heli_task_3_integral_h_
#include <stddef.h>
#include <string.h>
#ifndef heli_task_3_integral_COMMON_INCLUDES_
# define heli_task_3_integral_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_task_3_integral_COMMON_INCLUDES_ */

#include "heli_task_3_integral_types.h"
...
#define heli_task_3_integral_rtModel   RT_MODEL_heli_task_3_integral_T
...
typedef struct {
  ...
  real_T Fr[2];                        /* '<S4>/Product' */
  real_T Constant2[10];                /* '<S4>/Constant2' */
...
typedef struct {
  ...
  struct {
    void *FilePtr;
  } ToFile_PWORK_g;                    /* '<S2>/To File' */

  struct {
    void *FilePtr;
  } ToFile1_PWORK_j;                   /* '<S2>/To File1' */
  ...
  struct {
    int_T Count;
    int_T Decimation;
  } ToFile_IWORK_b;                    /* '<S2>/To File' */

  struct {
    int_T Count;
    int_T Decimation;
  } ToFile1_IWORK_c;                   /* '<S2>/To File1' */
} DW_heli_task_3_integral_T;
...
#define rtB                            heli_task_3_integral_B
#define BlockIO                        B_heli_task_3_integral_T
#define rtX                            heli_task_3_integral_X
#define ContinuousStates               X_heli_task_3_integral_T
#define rtXdot                         heli_task_3_integral_XDot
#define StateDerivatives               XDot_heli_task_3_integral_T
#define tXdis                          heli_task_3_integral_XDis
#define StateDisabled                  XDis_heli_task_3_integral_T
#define rtP                            heli_task_3_integral_P
#define Parameters                     P_heli_task_3_integral_T
#define rtDWork                        heli_task_3_integral_DW
#define D_Work                         DW_heli_task_3_integral_T

/* Parameters (auto storage) */
struct P_heli_task_3_integral_T_ {
  ...
  real_T Frontgain_Gain;               /* Expression: 0.5
                                        ...
                                        */
  real_T Constant_Value;               /* Expression: 0.505
...
struct tag_RTM_heli_task_3_integral_T {
  const char_T *path;
...
extern P_heli_task_3_integral_T heli_task_3_integral_P;

/* Block signals (auto storage) */
extern B_heli_task_3_integral_T heli_task_3_integral_B;

/* Continuous states (auto storage) */
extern X_heli_task_3_integral_T heli_task_3_integral_X;

/* Block states (auto storage) */
extern DW_heli_task_3_integral_T heli_task_3_integral_DW;
...
extern void heli_task_3_integral_initialize(void);
extern void heli_task_3_integral_output0(void);
extern void heli_task_3_integral_update0(void);
extern void heli_task_3_integral_output(int_T tid);
extern void heli_task_3_integral_update(int_T tid);
extern void heli_task_3_integral_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_task_3_integral_rtModel *heli_task_3_integral(void);
...
extern RT_MODEL_heli_task_3_integral_T *const heli_task_3_integral_M;
 ...
 *
 * '<Root>' : 'heli_task_3_integral'
 * '<S1>'   : 'heli_task_3_integral/Conversion'
 * '<S2>'   : 'heli_task_3_integral/Heli 3D'
 * '<S3>'   : 'heli_task_3_integral/Joystick'
 * '<S4>'   : 'heli_task_3_integral/Multivariable controller'
 */
#endif                                 /* RTW_HEADER_heli_task_3_integral_h_ */
