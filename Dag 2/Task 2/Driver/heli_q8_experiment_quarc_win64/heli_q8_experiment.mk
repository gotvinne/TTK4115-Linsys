...
MODEL                = heli_q8_experiment
MODULES              = heli_q8_experiment_data.c heli_q8_experiment_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = heli_q8_experiment.mk
...
MODELLIB                  = heli_q8_experimentlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = heli_q8_experiment_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = D:\HELIKO~1\DAG~~~3\TASK~1\Driver
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\heli_q8_experiment_quarc_win64
