...
#ifndef RTW_HEADER_heli_q8_experiment_h_
#define RTW_HEADER_heli_q8_experiment_h_
#include <stddef.h>
#include <string.h>
#ifndef heli_q8_experiment_COMMON_INCLUDES_
# define heli_q8_experiment_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_q8_experiment_COMMON_INCLUDES_ */

#include "heli_q8_experiment_types.h"
...
#define heli_q8_experiment_rtModel     RT_MODEL_heli_q8_experiment_T
...
typedef struct {
  ...
  real_T Fr[2];                        /* '<S5>/Product' */
  real_T Constant2[6];                 /* '<S5>/Constant2' */
...
#define rtB                            heli_q8_experiment_B
#define BlockIO                        B_heli_q8_experiment_T
#define rtX                            heli_q8_experiment_X
#define ContinuousStates               X_heli_q8_experiment_T
#define rtXdot                         heli_q8_experiment_XDot
#define StateDerivatives               XDot_heli_q8_experiment_T
#define tXdis                          heli_q8_experiment_XDis
#define StateDisabled                  XDis_heli_q8_experiment_T
#define rtP                            heli_q8_experiment_P
#define Parameters                     P_heli_q8_experiment_T
#define rtDWork                        heli_q8_experiment_DW
#define D_Work                         DW_heli_q8_experiment_T

/* Parameters (auto storage) */
struct P_heli_q8_experiment_T_ {
...
struct tag_RTM_heli_q8_experiment_T {
  const char_T *path;
...
extern P_heli_q8_experiment_T heli_q8_experiment_P;

/* Block signals (auto storage) */
extern B_heli_q8_experiment_T heli_q8_experiment_B;

/* Continuous states (auto storage) */
extern X_heli_q8_experiment_T heli_q8_experiment_X;

/* Block states (auto storage) */
extern DW_heli_q8_experiment_T heli_q8_experiment_DW;
...
extern void heli_q8_experiment_initialize(void);
extern void heli_q8_experiment_output0(void);
extern void heli_q8_experiment_update0(void);
extern void heli_q8_experiment_output(int_T tid);
extern void heli_q8_experiment_update(int_T tid);
extern void heli_q8_experiment_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_q8_experiment_rtModel *heli_q8_experiment(void);
...
extern RT_MODEL_heli_q8_experiment_T *const heli_q8_experiment_M;
 ...
 *
 * '<Root>' : 'heli_q8_experiment'
 * '<S1>'   : 'heli_q8_experiment/Conversion'
 * '<S2>'   : 'heli_q8_experiment/Elevation controller'
 * '<S3>'   : 'heli_q8_experiment/Heli 3D'
 * '<S4>'   : 'heli_q8_experiment/Joystick'
 * '<S5>'   : 'heli_q8_experiment/Multivariable controller'
 * '<S6>'   : 'heli_q8_experiment/Elevation controller/Elevation controller'
 */
#endif                                 /* RTW_HEADER_heli_q8_experiment_h_ */
