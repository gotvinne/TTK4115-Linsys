...
P_heli_q8_experiment_T heli_q8_experiment_P = {
  /*  Variable: F
   * Referenced by: '<S5>/Constant'
   */
  { 0.0, 18.165137614678873, 42.330275229357731, 0.0 },
   ...
   */
  { 0.0, 18.165137614678873, 0.0, 9.0825688073394382, 42.330275229357731, 0.0 },
  9.0,                                 /* Variable: Vs_0
