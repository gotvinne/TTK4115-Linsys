...
MODEL                = heli_joystick_control
MODULES              = heli_joystick_control_data.c heli_joystick_control_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = heli_joystick_control.mk
...
MODELLIB                  = heli_joystick_controllib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = heli_joystick_control_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = D:\HELIKO~1\DAG2~1\TASK2~1\Driver
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\heli_joystick_control_quarc_win64
