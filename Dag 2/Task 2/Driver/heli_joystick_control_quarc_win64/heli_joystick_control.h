...
#ifndef RTW_HEADER_heli_joystick_control_h_
#define RTW_HEADER_heli_joystick_control_h_
#include <stddef.h>
#include <string.h>
#ifndef heli_joystick_control_COMMON_INCLUDES_
# define heli_joystick_control_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_joystick_control_COMMON_INCLUDES_ */

#include "heli_joystick_control_types.h"
...
#define heli_joystick_control_rtModel  RT_MODEL_heli_joystick_contro_T
...
typedef struct {
  ...
  real_T Constant2[6];                 /* '<S4>/Constant2' */
...
#define rtB                            heli_joystick_control_B
#define BlockIO                        B_heli_joystick_control_T
#define rtX                            heli_joystick_control_X
#define ContinuousStates               X_heli_joystick_control_T
#define rtXdot                         heli_joystick_control_XDot
#define StateDerivatives               XDot_heli_joystick_control_T
#define tXdis                          heli_joystick_control_XDis
#define StateDisabled                  XDis_heli_joystick_control_T
#define rtP                            heli_joystick_control_P
#define Parameters                     P_heli_joystick_control_T
#define rtDWork                        heli_joystick_control_DW
#define D_Work                         DW_heli_joystick_control_T

/* Parameters (auto storage) */
struct P_heli_joystick_control_T_ {
...
struct tag_RTM_heli_joystick_control_T {
  const char_T *path;
...
extern P_heli_joystick_control_T heli_joystick_control_P;

/* Block signals (auto storage) */
extern B_heli_joystick_control_T heli_joystick_control_B;

/* Continuous states (auto storage) */
extern X_heli_joystick_control_T heli_joystick_control_X;

/* Block states (auto storage) */
extern DW_heli_joystick_control_T heli_joystick_control_DW;
...
extern void heli_joystick_control_initialize(void);
extern void heli_joystick_control_output0(void);
extern void heli_joystick_control_update0(void);
extern void heli_joystick_control_output(int_T tid);
extern void heli_joystick_control_update(int_T tid);
extern void heli_joystick_control_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_joystick_control_rtModel *heli_joystick_control(void);
...
extern RT_MODEL_heli_joystick_contro_T *const heli_joystick_control_M;
 ...
 *
 * '<Root>' : 'heli_joystick_control'
 * '<S1>'   : 'heli_joystick_control/Conversion'
 * '<S2>'   : 'heli_joystick_control/Heli 3D'
 * '<S3>'   : 'heli_joystick_control/Joystick'
 * '<S4>'   : 'heli_joystick_control/Multivariable controller'
 */
#endif                                 /* RTW_HEADER_heli_joystick_control_h_ */
