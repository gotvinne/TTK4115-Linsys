...
P_heli_joystick_control_T heli_joystick_control_P = {
  /*  Variable: F
   * Referenced by: '<S4>/Constant'
   */
  { 0.0, 11.353211009174291, 35.275229357798111, 0.0 },
   ...
   */
  { 0.0, 11.353211009174291, 0.0, 9.0825688073394328, 35.275229357798111, 0.0 },
  9.0,                                 /* Variable: Vs_0
