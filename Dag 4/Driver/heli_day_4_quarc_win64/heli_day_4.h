...
#ifndef RTW_HEADER_heli_day_4_h_
#define RTW_HEADER_heli_day_4_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef heli_day_4_COMMON_INCLUDES_
# define heli_day_4_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_day_4_COMMON_INCLUDES_ */

#include "heli_day_4_types.h"
...
#define heli_day_4_rtModel             RT_MODEL_heli_day_4_T
...
typedef struct {
  ...
  real_T Fr[2];                        /* '<S7>/Product' */
  real_T Constant2[10];                /* '<S7>/Constant2' */
  ...
  real_T Sum2;                         /* '<S7>/Sum2' */
  real_T Sum3;                         /* '<S7>/Sum3' */
  real_T x_apriori[5];                 /* '<S6>/Prediction step' */
  real_T P_apriori[25];                /* '<S6>/Prediction step' */
  real_T x_posteriori[5];              /* '<S6>/Correction step' */
  real_T P_posteriori[25];             /* '<S6>/Correction step' */
  uint8_T StreamCall1_o2;              /* '<S4>/Stream Call1' */
} B_heli_day_4_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T UnitDelay_DSTATE[5];          /* '<S6>/Unit Delay' */
  real_T UnitDelay1_DSTATE[25];        /* '<S6>/Unit Delay1' */
...
#define rtB                            heli_day_4_B
#define BlockIO                        B_heli_day_4_T
#define rtX                            heli_day_4_X
#define ContinuousStates               X_heli_day_4_T
#define rtXdot                         heli_day_4_XDot
#define StateDerivatives               XDot_heli_day_4_T
#define tXdis                          heli_day_4_XDis
#define StateDisabled                  XDis_heli_day_4_T
#define rtP                            heli_day_4_P
#define Parameters                     P_heli_day_4_T
#define rtDWork                        heli_day_4_DW
#define D_Work                         DW_heli_day_4_T

/* Parameters (auto storage) */
struct P_heli_day_4_T_ {
  real_T A_d[25];                      /* Variable: A_d
                                        * Referenced by: '<S6>/Prediction step'
                                        */
  real_T B_d[10];                      /* Variable: B_d
                                        * Referenced by: '<S6>/Prediction step'
                                        */
  real_T C_d[25];                      /* Variable: C_d
                                        * Referenced by: '<S6>/Correction step'
                                        */
  ...
  real_T K[10];                        /* Variable: K
                                        ...
                                        */
  real_T P_init[25];                   /* Variable: P_init
                                        * Referenced by: '<S6>/Unit Delay1'
                                        */
  real_T Q_d[25];                      /* Variable: Q_d
                                        * Referenced by: '<S6>/Prediction step'
                                        */
  ...
  real_T Vs_0;                         /* Variable: Vs_0
                                        ...
                                        */
  real_T x_init[5];                    /* Variable: x_init
  ...
  real_T Constant_Value_k;             /* Expression: 0
                                        ...
                                        */
  real_T Constant1_Value_g;            /* Expression: 65
  ...
  real_T Gain1_Gain;                   /* Expression: -1
                                        ...
                                        */
  real_T Gain1_Gain_h[9];              /* Expression: [ 0, 0, 1; 0, 1, 0; -1, 0, 0]
  ...
  real_T ElevationCounttorad_Gain;     /* Expression: -2 * pi /4096
                                        ...
                                        */
  real_T Constant_Value_j;             /* Expression: 0.505
...
extern P_heli_day_4_T heli_day_4_P;

/* Block signals (auto storage) */
extern B_heli_day_4_T heli_day_4_B;

/* Continuous states (auto storage) */
extern X_heli_day_4_T heli_day_4_X;

/* Block states (auto storage) */
extern DW_heli_day_4_T heli_day_4_DW;
...
extern void heli_day_4_initialize(void);
extern void heli_day_4_output0(void);
extern void heli_day_4_update0(void);
extern void heli_day_4_output(int_T tid);
extern void heli_day_4_update(int_T tid);
extern void heli_day_4_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_day_4_rtModel *heli_day_4(void);
...
extern RT_MODEL_heli_day_4_T *const heli_day_4_M;
 ...
 *
 * '<Root>' : 'heli_day_4'
 * '<S1>'   : 'heli_day_4/Conversion'
 * '<S2>'   : 'heli_day_4/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S3>'   : 'heli_day_4/Heli 3D'
 * '<S4>'   : 'heli_day_4/IMU'
 * '<S5>'   : 'heli_day_4/Joystick'
 * '<S6>'   : 'heli_day_4/Kalman filter'
 * '<S7>'   : 'heli_day_4/Multivariable controller'
 * '<S8>'   : 'heli_day_4/Subsystem'
 * '<S9>'   : 'heli_day_4/Kalman filter/Correction step'
 * '<S10>'  : 'heli_day_4/Kalman filter/Prediction step'
 */
#endif                                 /* RTW_HEADER_heli_day_4_h_ */
