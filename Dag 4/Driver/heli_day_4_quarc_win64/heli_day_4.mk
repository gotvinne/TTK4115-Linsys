...
MODEL                = heli_day_4
MODULES              = heli_day_4_data.c heli_day_4_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = heli_day_4.mk
...
MODELLIB                  = heli_day_4lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = heli_day_4_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = D:\HELIKO~1\DAG4~1\Driver
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\heli_day_4_quarc_win64
