...
#ifndef RTW_HEADER_heli_task_3_h_
#define RTW_HEADER_heli_task_3_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef heli_task_3_COMMON_INCLUDES_
# define heli_task_3_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_task_3_COMMON_INCLUDES_ */

#include "heli_task_3_types.h"
...
#define heli_task_3_rtModel            RT_MODEL_heli_task_3_T
...
typedef struct {
  ...
  real_T A[25];                        /* '<S8>/A' */
  real_T C[25];                        /* '<S8>/C' */
  real_T Constant[10];                 /* '<S8>/Constant' */
  real_T Constant1_g[25];              /* '<S8>/Constant1' */
  real_T Sum_l[5];                     /* '<S8>/Sum' */
...
#define rtB                            heli_task_3_B
#define BlockIO                        B_heli_task_3_T
#define rtX                            heli_task_3_X
#define ContinuousStates               X_heli_task_3_T
#define rtXdot                         heli_task_3_XDot
#define StateDerivatives               XDot_heli_task_3_T
#define tXdis                          heli_task_3_XDis
#define StateDisabled                  XDis_heli_task_3_T
#define rtP                            heli_task_3_P
#define Parameters                     P_heli_task_3_T
#define rtDWork                        heli_task_3_DW
#define D_Work                         DW_heli_task_3_T

/* Parameters (auto storage) */
struct P_heli_task_3_T_ {
  ...
  uint8_T StreamCall1_Endian;          /* Computed Parameter: StreamCall1_Endian
                                        * Referenced by: '<S4>/Stream Call1'
                                        */
  uint8_T Feedbackselector_CurrentSetting;/* Computed Parameter: Feedbackselector_CurrentSetting
...
extern P_heli_task_3_T heli_task_3_P;

/* Block signals (auto storage) */
extern B_heli_task_3_T heli_task_3_B;

/* Continuous states (auto storage) */
extern X_heli_task_3_T heli_task_3_X;

/* Block states (auto storage) */
extern DW_heli_task_3_T heli_task_3_DW;
...
extern void heli_task_3_initialize(void);
extern void heli_task_3_output0(void);
extern void heli_task_3_update0(void);
extern void heli_task_3_output(int_T tid);
extern void heli_task_3_update(int_T tid);
extern void heli_task_3_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_task_3_rtModel *heli_task_3(void);
...
extern RT_MODEL_heli_task_3_T *const heli_task_3_M;
 ...
 *
 * '<Root>' : 'heli_task_3'
 * '<S1>'   : 'heli_task_3/Conversion'
 * '<S2>'   : 'heli_task_3/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S3>'   : 'heli_task_3/Heli 3D'
 * '<S4>'   : 'heli_task_3/IMU'
 * '<S5>'   : 'heli_task_3/Joystick'
 * '<S6>'   : 'heli_task_3/Multivariable controller'
 * '<S7>'   : 'heli_task_3/Subsystem'
 * '<S8>'   : 'heli_task_3/Subsystem1'
 */
#endif                                 /* RTW_HEADER_heli_task_3_h_ */
