...
#ifndef RTW_HEADER_heli_day_3_h_
#define RTW_HEADER_heli_day_3_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef heli_day_3_COMMON_INCLUDES_
# define heli_day_3_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* heli_day_3_COMMON_INCLUDES_ */

#include "heli_day_3_types.h"
...
#define heli_day_3_rtModel             RT_MODEL_heli_day_3_T
...
#define rtB                            heli_day_3_B
#define BlockIO                        B_heli_day_3_T
#define rtX                            heli_day_3_X
#define ContinuousStates               X_heli_day_3_T
#define rtXdot                         heli_day_3_XDot
#define StateDerivatives               XDot_heli_day_3_T
#define tXdis                          heli_day_3_XDis
#define StateDisabled                  XDis_heli_day_3_T
#define rtP                            heli_day_3_P
#define Parameters                     P_heli_day_3_T
#define rtDWork                        heli_day_3_DW
#define D_Work                         DW_heli_day_3_T

/* Parameters (auto storage) */
struct P_heli_day_3_T_ {
...
extern P_heli_day_3_T heli_day_3_P;

/* Block signals (auto storage) */
extern B_heli_day_3_T heli_day_3_B;

/* Continuous states (auto storage) */
extern X_heli_day_3_T heli_day_3_X;

/* Block states (auto storage) */
extern DW_heli_day_3_T heli_day_3_DW;
...
extern void heli_day_3_initialize(void);
extern void heli_day_3_output0(void);
extern void heli_day_3_update0(void);
extern void heli_day_3_output(int_T tid);
extern void heli_day_3_update(int_T tid);
extern void heli_day_3_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern heli_day_3_rtModel *heli_day_3(void);
...
extern RT_MODEL_heli_day_3_T *const heli_day_3_M;
 ...
 *
 * '<Root>' : 'heli_day_3'
 * '<S1>'   : 'heli_day_3/Conversion'
 * '<S2>'   : 'heli_day_3/Gyro vector to [pitch rate, elevation rate, travle rate]'
 * '<S3>'   : 'heli_day_3/Heli 3D'
 * '<S4>'   : 'heli_day_3/IMU'
 * '<S5>'   : 'heli_day_3/Joystick'
 * '<S6>'   : 'heli_day_3/Multivariable controller'
 * '<S7>'   : 'heli_day_3/Subsystem'
 */
#endif                                 /* RTW_HEADER_heli_day_3_h_ */
